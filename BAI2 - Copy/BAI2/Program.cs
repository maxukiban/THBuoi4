...
namespace BAI2
{
    class Program
    {
        ...
        {
            // do a specific range
            Console.WriteLine("> Checking ports on localhost...\n");
            Console.Write("Enter start port : ");
            int sport = int.Parse(Console.ReadLine());
            Console.Write("Enter end port : ");
            int eport = int.Parse(Console.ReadLine());
            PortScanner cps = new PortScanner("172.16.0.1", sport, eport);
    ...
    internal class PortScanner
    {
        ...
        public string Host { get; } = "172.16.0.1"; // localhost
